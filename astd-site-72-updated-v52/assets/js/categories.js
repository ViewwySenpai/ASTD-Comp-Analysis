...
"buddha-chairman-serious": {boost:{cat:"Martial Artist",atk:20},leader:{th:"ยูนิตในหมวด Martial Artist ได้ดาเมจเพิ่ม 20% และโบนัสอีก 20%",en:"Units in the Martial Artist category gain a 20% attack boost and a 20% bonus."},tags:["Captains","Mutilate","Spirit Warriors","Martial Artist","Master Class","Prodigy"]},
"evil-shade-final": {boost:{cat:"Depraved Demons",atk:20},leader:{th:"ยูนิตในหมวด Depraved Demons ได้ดาเมจเพิ่ม 20% และโบนัสอีก 20%",en:"Units in the Depraved Demons category gain a 20% attack boost and a 20% bonus."},tags:["Depraved Demons","Mutilate","Undead","Spirit Warriors","Pure Evil","Perception"]},
"dr-heart-mystical": {boost:{cat:"Master Class",atk:15},leader:{th:"ยูนิตในหมวด Master Class ได้ดาเมจเพิ่ม 15%",en:"Units in the Master Class category gain a 15% attack boost."},tags:["Captains","Master Class","Unrivaled Intelligence","Prodigy"]},
"medukami": {boost:{cat:"Godly",atk:15},leader:{th:"ยูนิตในหมวด Godly ได้ดาเมจเพิ่ม 15%",en:"Units in the Godly category gain a 15% attack boost."},tags:["Pure Hearted","Godly","Protectors of The Universe","Youth","Girls"]},
"wrathdioas-demon-king": {boost:{cat:"Revival",atk:20},leader:{th:"ยูนิตในหมวด Revival ได้ดาเมจเพิ่ม 20% และเงินเพิ่ม 20%",en:"Units in the Revival category gain a 20% attack boost and a 20% money boost."},tags:["Captains","Depraved Demons","Godlike Power","Love Rhythm","Youth","Revival"]},
"the-strongest-in-history": {boost:{cat:"Pure Evil",atk:20},leader:{th:"ยูนิตในหมวด Pure Evil ได้ดาเมจเพิ่ม 20% และโบนัสอีก 15%",en:"Units in the Pure Evil category gain a 20% attack boost and a 15% bonus."},tags:["Godlike Power","Unrivaled Intelligence","Pure Evil","Mutilate","Prodigy","Final Bosses"]},
"ruffy-5th-form": {boost:{cat:"Revival",atk:20},leader:{th:"ยูนิตในหมวด Revival ได้ดาเมจเพิ่ม 20%",en:"Units in the Revival category gain a 20% attack boost."},tags:["Pure Hearted","Captains","Siblings","Prodigy","Legendary Lineage","Revival"]},
"octo-the-greedy": {tags:["Thief","Prodigy","Armsman"]},
"vegu-ego-ascension": {
  boost:{cats:["Prodigy","Godlike Power"],atk:22},
  leader:{th:"ยูนิตในหมวด Prodigy หรือ Godlike Power ได้ดาเมจเพิ่ม 22%",en:"Units in the Prodigy or Godlike Power category gain a 22% attack boost."},
  tags:["Godlike Power","Raging Power","Love Rhythm","Prodigy","Legendary Lineage","Unworldly Beings"]
},
};

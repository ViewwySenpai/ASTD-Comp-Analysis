...
/* Octo The Greedy — Farm unit (Level 175), total cost 998,000 */
"octo-the-greedy": [
  {lv:0,  cost:500,    farm:149,    stored:500,    note:{th:"ยูนิตฟาร์ม / ได้เงินต่อเวฟ",en:"Farm unit / provides cash per wave"}},
  {lv:1,  cost:500,    farm:299,    stored:1000,   note:"Wise Deposit!"},
  {lv:2,  cost:500,    farm:299,    stored:1500,   note:"Wise Deposit!"},
  {lv:3,  cost:500,    farm:598,    stored:2000},
  {lv:4,  cost:500,    farm:748,    stored:2500},
  {lv:5,  cost:900,    farm:1010,   stored:3400},
  {lv:6,  cost:1550,   farm:1480,   stored:4950,   note:"Thinking long-term, aren't we?"},
  {lv:7,  cost:1750,   farm:2000,   stored:6700},
  {lv:8,  cost:2200,   farm:2660,   stored:8900},
  {lv:9,  cost:3100,   farm:3590,   stored:12000},
  {lv:10, cost:5500,   farm:5240,   stored:17500},
  {lv:11, cost:6400,   farm:7150,   stored:23900,  note:"I won't say no to cash!"},
  {lv:12, cost:8800,   farm:9790,   stored:32700},
  {lv:13, cost:12000,  farm:13300,  stored:44700},
  {lv:14, cost:13500,  farm:17400,  stored:58200},
  {lv:15, cost:25000,  farm:24900,  stored:83200},
  {lv:16, cost:40000,  farm:36800,  stored:123000, note:"Yes yes, keep the money flowing!"},
  {lv:17, cost:65000,  farm:56300,  stored:188000},
  {lv:18, cost:80000,  farm:80300,  stored:268000},
  {lv:19, cost:100000, farm:110000, stored:368000},
  {lv:20, cost:125000, farm:147000, stored:493000},
  {lv:21, cost:140000, farm:189000, stored:633000},
  {lv:22, cost:165000, farm:239000, stored:798000, note:"You've hit your limit, friend!"},
  {lv:23, cost:200000, farm:298000, stored:998000},
],
...
/* Police Girl (Vamp) — 6★ (Level 175).
   Bleed DPS = Damage ×5÷8 through Upgrade 5, then ×5÷10 at Upgrades 6–8.
   Bleed is a shared status, so extra placed copies do not increase Bleed DPS. */
"police-girl-vamp": [
  {lv:0, cost:666,     dmg:27846,   rng:90,  spa:8, bleed:{mult:5,div:8, scaleCopies:false}, note:"Ground / AoE (Cone)"},
  {lv:1, cost:2500,    dmg:63831.6, rng:90,  spa:8, bleed:{mult:5,div:8, scaleCopies:false}},
  {lv:2, cost:5000,    dmg:151867.8,rng:90,  spa:8, bleed:{mult:5,div:8, scaleCopies:false}},
  {lv:3, cost:9000,    dmg:342720,  rng:120, spa:8, bleed:{mult:5,div:8, scaleCopies:false}, note:"+ Whole Lotta Red"},
  {lv:4, cost:15000,   dmg:758268,  rng:120, spa:8, bleed:{mult:5,div:8, scaleCopies:false}},
  {lv:5, cost:22000,   dmg:1559376, rng:120, spa:8, bleed:{mult:5,div:8, scaleCopies:false}},
  {lv:6, cost:25000,   dmg:1998486, rng:160, spa:5, bleed:{mult:5,div:10,scaleCopies:false}, note:"+ Adieu, Monsieur / AoE (Circle)"},
  {lv:7, cost:26800,   dmg:3362940, rng:160, spa:5, bleed:{mult:5,div:10,scaleCopies:false}},
  {lv:8, cost:1800000, dmg:7497000, rng:160, spa:5, bleed:{mult:5,div:10,scaleCopies:false}},
],
...
/* Buddha Chairman (Serious) — 7★ (Level 175) */
"buddha-chairman-serious": [
  {lv:0,cost:700,      dmg:23990.4,  rng:70, spa:4, note:"Ground / AoE (Cone)"},
  {lv:1,cost:6000,     dmg:99817.2,  rng:70, spa:4},
  {lv:2,cost:23300,    dmg:749700,   rng:85, spa:5, note:"+ Buddha Beam"},
  {lv:3,cost:150000,   dmg:4990860,  rng:85, spa:5},
  {lv:4,cost:320000,   dmg:22276800, rng:100,spa:8, note:{th:"+ Life Craft / เปลี่ยนเป็น AoE (Circle)",en:"+ Life Craft / Attack type changes to AoE (Circle)"}},
  {lv:5,cost:500000,   dmg:49908600, rng:100,spa:8},
  {lv:6,cost:21000000, dmg:293454000,rng:100,spa:8, note:{th:"+ Flower Explosion / ได้สกิลกด",en:"+ Flower Explosion / Obtains the manual ability"}},
],

/* Evil Shade (Final) — 7★ (Level 175) */
"evil-shade-final": [
  {lv:0,cost:400,     dmg:29998.71, rng:70, spa:4, note:"Ground / AoE (Cone)"},
  {lv:1,cost:3600,    dmg:79896.6,  rng:70, spa:4},
  {lv:2,cost:7000,    dmg:249114.6, rng:85, spa:5, note:{th:"+ Darkness Tear / เปลี่ยนเป็น AoE (Circle)",en:"+ Darkness Tear / Attack type changes to AoE (Circle)"}},
  {lv:3,cost:15000,   dmg:499086,   rng:85, spa:5},
  {lv:4,cost:25000,   dmg:1390158,  rng:100,spa:8, note:{th:"+ Eternal Fire / เปลี่ยนเป็น AoE (Cone)",en:"+ Eternal Fire / Attack type changes to AoE (Cone)"}},
  {lv:5,cost:59000,   dmg:2390472,  rng:100,spa:8},
  {lv:6,cost:120000,  dmg:2795310,  rng:130,spa:4, note:{th:"+ Hybrid / เปลี่ยนเป็น AoE (Circle) / ตีอากาศได้",en:"+ Hybrid / Attack type changes to AoE (Circle) / Can hit air"}},
  {lv:7,cost:250000,  dmg:4789512,  rng:130,spa:4, note:{th:"+ Dragon Absorption / ได้สกิลกด",en:"+ Dragon Absorption / Obtains the manual ability"}},
  {lv:8,cost:15000000,dmg:44403660, rng:130,spa:10.2,note:{th:"+ Darkness Flame / ได้สกิลกด",en:"+ Darkness Flame / Obtains the manual ability"}},
  {lv:9,cost:0,dmg:44403660,flat:7500000,rng:130,spa:10.2,name:"Dragon Absorption",abilityDps:{label:"Black Flame",mult:21,cd:40.8},
   note:{th:"ดาเมจถาวร +7,500,000 และรวม Black Flame DPS = ดาเมจปัจจุบัน ×21 ÷40.8",en:"Permanent +7,500,000 damage; includes Black Flame DPS = current damage ×21 ÷40.8"}},
],

/* Dr. Heart (Mystical) — 6★ (Level 175) */
"dr-heart-mystical": [
  {lv:0,cost:20000,  dmg:353430, rng:40, spa:9,note:"Air / AoE (Circle)"},
  {lv:1,cost:3000,   dmg:443394, rng:40, spa:9,note:{th:"ได้สกิล Replacement II",en:"Obtains Replacement II manual ability"}},
  {lv:2,cost:7500,   dmg:668304, rng:100,spa:9,note:{th:"+ Shock / เปลี่ยนเป็น AoE (Cone)",en:"+ Shock / Attack type changes to AoE (Cone)"}},
  {lv:3,cost:15000,  dmg:1336608,rng:100,spa:9},
  {lv:4,cost:650000, dmg:1972782,rng:100,spa:9},
  {lv:5,cost:900000, dmg:3041640,rng:110,spa:9,note:{th:"+ Puncture / เปลี่ยนเป็น AoE (Full)",en:"+ Puncture / Attack type changes to AoE (Full)"}},
  {lv:6,cost:3400000,dmg:4476780,rng:110,spa:9,note:{th:"ได้สกิล Silent",en:"Obtains Silent manual ability"}},
],

/* Medukami — 6★ (Level 175) */
"medukami": [
  {lv:0,cost:650,    dmg:10174.5, rng:40, spa:8,note:"Air / AoE (Full)"},
  {lv:1,cost:2550,   dmg:57191.4, rng:40, spa:8},
  {lv:2,cost:4700,   dmg:216342,  rng:40, spa:8},
  {lv:3,cost:6500,   dmg:672588,  rng:80, spa:8,note:{th:"+ Flower Barrage / เปลี่ยนเป็น AoE (Circle)",en:"+ Flower Barrage / Attack type changes to AoE (Circle)"}},
  {lv:4,cost:30200,  dmg:1591506, rng:80, spa:8},
  {lv:5,cost:1650000,dmg:10774260,rng:110,spa:8,note:{th:"+ Rainbow Rift / เปลี่ยนเป็น AoE (Full)",en:"+ Rainbow Rift / Attack type changes to AoE (Full)"}},
],

/* Wrathdioas (Demon King) — 7★ (Level 175) */
"wrathdioas-demon-king": [
  {lv:0,cost:400,    dmg:20349,   rng:50, spa:8,note:"Ground / AoE (Cone)"},
  {lv:1,cost:3600,   dmg:110313,  rng:50, spa:8},
  {lv:2,cost:4500,   dmg:340578,  rng:50, spa:8},
  {lv:3,cost:14000,  dmg:672588,  rng:70, spa:8,note:{th:"+ Doom Flame Tornado / เปลี่ยนเป็น AoE (Circle)",en:"+ Doom Flame Tornado / Attack type changes to AoE (Circle)"}},
  {lv:4,cost:19500,  dmg:1313046, rng:70, spa:8,note:"+ Hybrid"},
  {lv:5,cost:460000, dmg:1992060, rng:110,spa:8,note:"+ Final Charge (D) / larger AoE Circle"},
  {lv:6,cost:1000000,dmg:2613240, rng:110,spa:8,abilityDps:{label:"Disintegration",mult:1.25,cd:45},
   note:{th:"+ SPECIAL MOVE / ได้สกิล Disintegration / รวม Ability DPS = ดาเมจ ×1.25 ÷45",en:"+ SPECIAL MOVE / Obtains Disintegration / Includes Ability DPS = damage ×1.25 ÷45"}},
  {lv:7,cost:500000, dmg:10538640,rng:110,spa:8,abilityDps:{label:"Disintegration",mult:1.25,cd:45},
   note:{th:"รวม Ability DPS = ดาเมจ ×1.25 ÷45",en:"Includes Ability DPS = damage ×1.25 ÷45"}},
],

/* The Strongest In History — 7★ (Level 175)
   Rupture: 12 ticks, each tick deals 25% damage.
   Rupture DPS: Damage ×25% ×12 ÷24 ที่ขั้น 5–6 และ ÷25.5 ที่ขั้น 7 */
"the-strongest-in-history": [
  {lv:0,cost:2000,    dmg:29988,    rng:80, spa:5,note:"Ground / AoE (Circle)"},
  {lv:1,cost:70000,   dmg:999243,   rng:80, spa:5},
  {lv:2,cost:120000,  dmg:3748500,  rng:80, spa:5},
  {lv:3,cost:150000,  dmg:6982920,  rng:120,spa:4,note:{th:"+ Hybrid / เปลี่ยนเป็น AoE (Cone) / ตีอากาศได้",en:"+ Hybrid / Attack type changes to AoE (Cone) / Can hit air enemies"}},
  {lv:4,cost:450000,  dmg:12594960, rng:120,spa:4},
  {lv:5,cost:8000000, dmg:17992800, rng:180,spa:3,abilityDps:{label:"Rupture",mult:3,cd:24},note:{th:"+ Definitive Rupture / Rupture 12 ครั้ง ครั้งละ 25% / รวม DPS = ดาเมจ ×3 ÷24",en:"+ Definitive Rupture / 12 Rupture ticks at 25% each / Includes DPS = damage ×3 ÷24"}},
  {lv:6,cost:9000000, dmg:27203400, rng:180,spa:3,abilityDps:{label:"Rupture",mult:3,cd:24},note:{th:"+ Waffle Maker / ได้สกิลกด / รวม Rupture DPS (ครั้งละ 25%)",en:"+ Waffle Maker / Obtains the manual ability / Includes Rupture DPS (25% per tick)"}},
  {lv:7,cost:11000000,dmg:116310600,rng:180,spa:8.5,abilityDps:{label:"Rupture",mult:3,cd:25.5},note:{th:"+ Incomplete Shrine / ได้สกิลกด / Rupture DPS = ดาเมจ ×3 ÷25.5",en:"+ Incomplete Shrine / Obtains the manual ability / Rupture DPS = damage ×3 ÷25.5"}},
],

/* Vegu (Ego Ascension) — 7★ (Level 175)
   Rage เพิ่ม 2,699,999.57 ต่อเวฟที่ขั้น 6–7 สูงสุด 12 เวฟ = 32,399,994.84
   Wounded Pride เพิ่มถาวร 61,200,000 หนึ่งครั้ง
   ทั้ง Rage และ Wounded Pride ไม่คูณ Leader / Orb แต่รับบัฟอื่นตามปกติ */
"vegu-ego-ascension": [
  {lv:0,cost:500,    dmg:17864.28, rng:50, spa:4,
   note:{th:"Ground / AoE (Cone) / Rage +1,120.27 ดาเมจต่อเวฟ / ฐานเสีย 100 HP ต่อเวฟ",en:"Ground / AoE (Cone) / Rage +1,120.27 damage per wave / deals 100 damage to the base per wave"}},
  {lv:1,cost:1500,   dmg:67901.4,  rng:50, spa:4},
  {lv:2,cost:13000,  dmg:359856,   rng:50, spa:4,
   note:{th:"+ Spirit Fission / ได้สกิลกด",en:"+ Spirit Fission / Obtains the manual ability"}},
  {lv:3,cost:25000,  dmg:1242360,  rng:110,spa:5,
   note:{th:"+ Prideful Beam / Rage +59,999.56 ดาเมจต่อเวฟ / ฐานเสีย 1,998.49 HP ต่อเวฟ",en:"+ Prideful Beam / Rage +59,999.56 damage per wave / deals 1,998.49 damage to the base per wave"}},
  {lv:4,cost:80000,  dmg:3489318,  rng:110,spa:5},
  {lv:5,cost:200000, dmg:8996400,  rng:110,spa:5},
  {lv:6,cost:7600000,dmg:26989200, rng:110,spa:7.5,
   note:{th:"+ Wounded Pride / เปลี่ยนเป็น AoE (Circle) / Rage +2,699,999.57 ต่อเวฟ สูงสุด 12 เวฟ / ฐานเสีย 499,985.64 HP ต่อเวฟ",en:"+ Wounded Pride / Changes to AoE (Circle) / Rage +2,699,999.57 per wave, up to 12 waves / deals 499,985.64 damage to the base per wave"}},
  {lv:6,cost:0,dmg:26989200,flat:32399994.84,flatSkip:["lead","orb"],rng:110,spa:7.5,name:"Upgrade 6 · Rage ×12",
   note:{th:"รวม Rage ครบ 12 เวฟ — ส่วนเพิ่มไม่รับบัฟ Leader และ Orb",en:"Includes all 12 Rage waves — the added damage ignores Leader and Orb buffs"}},
  {lv:6,cost:0,dmg:26989200,flat:61200000,flatSkip:["lead","orb"],rng:110,spa:7.5,name:"Upgrade 6 · Wounded Pride",
   note:{th:"รวม Wounded Pride +61,200,000 หนึ่งครั้ง — ไม่รับบัฟ Leader และ Orb",en:"Includes Wounded Pride +61,200,000 once — ignores Leader and Orb buffs"}},
  {lv:6,cost:0,dmg:26989200,flat:93599994.84,flatSkip:["lead","orb"],rng:110,spa:7.5,name:"Upgrade 6 · Rage ×12 + Wounded Pride",
   note:{th:"รวม Rage 12 เวฟและ Wounded Pride — ส่วนเพิ่มทั้งหมดไม่รับบัฟ Leader และ Orb",en:"Includes 12 Rage waves and Wounded Pride — all added damage ignores Leader and Orb buffs"}},
  {lv:7,cost:9000000,dmg:53978400, rng:110,spa:7.5,
   note:{th:"+ Instinctual Destruction / ได้สกิลกด",en:"+ Instinctual Destruction / Obtains the manual ability"}},
  {lv:7,cost:0,dmg:53978400,flat:32399994.84,flatSkip:["lead","orb"],rng:110,spa:7.5,name:"Upgrade 7 · Rage ×12",
   note:{th:"รวม Rage ครบ 12 เวฟ — ส่วนเพิ่มไม่รับบัฟ Leader และ Orb",en:"Includes all 12 Rage waves — the added damage ignores Leader and Orb buffs"}},
  {lv:7,cost:0,dmg:53978400,flat:61200000,flatSkip:["lead","orb"],rng:110,spa:7.5,name:"Upgrade 7 · Wounded Pride",
   note:{th:"รวม Wounded Pride +61,200,000 หนึ่งครั้ง — ไม่รับบัฟ Leader และ Orb",en:"Includes Wounded Pride +61,200,000 once — ignores Leader and Orb buffs"}},
  {lv:7,cost:0,dmg:53978400,flat:93599994.84,flatSkip:["lead","orb"],rng:110,spa:7.5,name:"Upgrade 7 · Rage ×12 + Wounded Pride",
   note:{th:"รวม Rage 12 เวฟและ Wounded Pride — ส่วนเพิ่มทั้งหมดไม่รับบัฟ Leader และ Orb",en:"Includes 12 Rage waves and Wounded Pride — all added damage ignores Leader and Orb buffs"}},
],

/* Ruffy (5th Form) — 7★ (Level 175) */
"ruffy-5th-form": [
  {lv:0,cost:15000,  dmg:263466,  rng:40, spa:6,note:"Ground / AoE (Full)"},
  {lv:1,cost:25000,  dmg:599760,  rng:45, spa:6},
  {lv:2,cost:40000,  dmg:1199520, rng:50, spa:6},
  {lv:3,cost:50000,  dmg:2399040, rng:60, spa:6},
  {lv:4,cost:65000,  dmg:3898440, rng:70, spa:6},
  {lv:5,cost:80000,  dmg:5997600, rng:70, spa:6,note:{th:"+ Hybrid / ตีศัตรูอากาศได้",en:"+ Hybrid / Can hit air enemies"}},
  {lv:6,cost:105000, dmg:6318900, rng:110,spa:4,note:{th:"+ Kaminari / เปลี่ยนเป็น AoE (Circle)",en:"+ Kaminari / Attack type changes to AoE (Circle)"}},
  {lv:7,cost:4000000,dmg:11995200,rng:120,spa:4},
  {lv:8,cost:6000000,dmg:22062600,rng:120,spa:4,note:{th:"+ Fifth Form Gun / ได้สกิลกด",en:"+ Fifth Form Gun / Obtains the manual ability"}},
  {lv:9,cost:8000000,dmg:37270800,rng:120,spa:4,note:{th:"+ Liberation / ได้สกิลกด",en:"+ Liberation / Obtains the manual ability"}},
],
...
/* Bleed: ค่า boolean ใช้สูตรเดิมของ Devil; object ใช้กำหนดสูตรเฉพาะขั้นและการซ้อน Amount */
function bleedSpec(name, row){
  if(row && row.bleed){
    return typeof row.bleed === "object" ? row.bleed : {mult:5, div:10, scaleCopies:true};
  }
  if(row) return null;
  const t = (typeof UPGRADES !== "undefined") ? UPGRADES[unitSlug(name)] : null;
  const maxRow = t ? ([...t].reverse().find(r => r.bleed) || null) : null;
  if(!maxRow) return null;
  return typeof maxRow.bleed === "object" ? maxRow.bleed : {mult:5, div:10, scaleCopies:true};
}
function hasBleed(name){
  return !!bleedSpec(name, null);
}
function bleedDps(dmg, name, row){
  const s = bleedSpec(name, row) || {mult:5, div:10, scaleCopies:true};
  return dmg > 0 && s.div > 0 ? dmg * (s.mult || 0) / s.div : 0;
}

/* DPS เฉลี่ยจาก Ability ที่ผูกกับขั้นอัปเกรด เช่น Black Flame / Disintegration */
function abilityDpsSpec(name, row){
  if(row && row.abilityDps) return row.abilityDps;
  if(row) return null;
  const t = (typeof UPGRADES !== "undefined") ? UPGRADES[unitSlug(name)] : null;
  const maxRow = t ? ([...t].reverse().find(r => !r.flat) || t[t.length-1]) : null;
  return maxRow && maxRow.abilityDps ? maxRow.abilityDps : null;
}
function abilityDpsOf(name, currentDamage, row){
  const s = abilityDpsSpec(name, row);
  return s && s.cd > 0 ? Math.max(0, currentDamage || 0) * s.mult / s.cd : 0;
}
function abilityDpsLabel(name, row){
  const s = abilityDpsSpec(name, row);
  return s ? `${s.label || "Ability"} DPS` : "Ability DPS";
}

/* dmg = ดาเมจของยูนิต "หนึ่งตัว" หลังบัฟ / copies = วางกี่ตัว
   ดาเมจพิษไม่เพิ่มตามจำนวนตัว (สถานะพิษไม่ซ้อนกัน) ส่วนที่เหลือคูณตามปกติ */
function unitTotalDps(name, dmg, spa, copies, row){
  if(!(spa > 0)) return 0;
  const n = Math.max(1, copies || 1);
  let out = (dmg / spa) * n;
  if(hasJudgement(name)) out += judgementDps(dmg, spa) * n;
  if(hasPoison(name))    out += poisonDps(dmg, spa);
  const bleed = bleedSpec(name, row || null);
  if(bleed) out += bleedDps(dmg, name, row || null) * (bleed.scaleCopies === false ? 1 : n);
  return out;
}
